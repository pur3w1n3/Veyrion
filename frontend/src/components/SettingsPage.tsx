  ...
  return <section>
    ...
    <article className="panel">
      ...
      <div className="setting-row">
        <div><strong>报告与模型输出语言</strong><small>只影响新创建的模型任务；旧结果是不可变快照，不会被翻译或改写。</small></div>
        <label className="language-select">
          <span className="sr-only">报告与模型输出语言</span>
      ...
      <div className="setting-row"><div><strong>默认出站网络</strong><small>固定禁止外网；前端不能放宽</small></div><span className="locked-tag">已锁定</span></div>
      <div className="setting-row"><div><strong>危险动作</strong><small>固定为空跑演练 / 模拟，不执行破坏性操作</small></div><span className="locked-tag">已锁定</span></div>
    </article>
  </section>
}
