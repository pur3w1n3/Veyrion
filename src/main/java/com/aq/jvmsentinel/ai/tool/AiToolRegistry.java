    ...
    private RegisteredTool factsSearch() {
        ...
        ToolDefinition definition = new ToolDefinition("facts_search",
                "Search already-indexed, read-only facts in the server-bound project. "
                        ...
                        + "FINDING returns findingId/title/status/sink/entry for bindings beyond prompt MAX_PROMPT_BINDINGS "
                        + "(deliverable report bindings are complete; prompt inline may be truncated). "
